...
export default function StickySearchBar({
  ...
  return (
    <div className="sticky bottom-0 z-30 mt-3 px-0 pb-4 pt-2">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div className="flex flex-wrap items-center gap-3 rounded-2xl border border-surface-3 bg-white/95 px-4 py-3 shadow-soft backdrop-blur">
          <select
        ...
        <div className="flex items-center gap-3 rounded-2xl border border-surface-3 bg-white/95 px-4 py-3 shadow-soft backdrop-blur">
